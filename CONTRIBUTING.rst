...
``panvimwiki`` documentation uses Sphinx_ as its main documentation compiler.
This means that the docs are kept in the same repository as the project code, and
that any documentation update is done in the same way was a code contribution; e.g.,  CommonMark_ with MyST_ extensions.
...
#. Clone this copy to your local disk::
    ...
    git clone https://github.com/YourLogin/panvimwiki.git
    cd panvimwiki
...
.. _repository: https://github.com/<USERNAME>/panvimwiki
.. _issue tracker: https://github.com/<USERNAME>/panvimwiki/issues
.. <-- end -->
